...
document.addEventListener("click", (e) => {
  if (offcanvasMenu && !offcanvasMenu.contains(e.target) && !menuIcon.contains(e.target)) {
    offcanvasMenu.classList.remove("active");
  }
});


// --- Collection Section --- (works only if section exists)
const scrollCollection = document.getElementById("box-collection");
const nextBtnCollection = document.getElementById("nextBtn-collection");
const prevBtnCollection = document.getElementById("prevBtn-collection");

if (scrollCollection && nextBtnCollection && prevBtnCollection) {
  nextBtnCollection.addEventListener("click", () => {
    scrollCollection.scrollBy({ left: 350, behavior: "smooth" });
  });

  prevBtnCollection.addEventListener("click", () => {
    scrollCollection.scrollBy({ left: -350, behavior: "smooth" });
  });
}
...
// --- New Arrival ---
const scrollNew = document.getElementById("box-new");
if (scrollNew) {
  document.getElementById("nextBtn-new").addEventListener("click", () =>
    scrollNew.scrollBy({ left: 350, behavior: "smooth" })
  );
  document.getElementById("prevBtn-new").addEventListener("click", () =>
    scrollNew.scrollBy({ left: -350, behavior: "smooth" })
  );
}
...
// --- Best Seller ---
const scrollBest = document.getElementById("box-best");
if (scrollBest) {
  document.getElementById("nextBtn-best").addEventListener("click", () =>
    scrollBest.scrollBy({ left: 350, behavior: "smooth" })
  );
  document.getElementById("prevBtn-best").addEventListener("click", () =>
    scrollBest.scrollBy({ left: -350, behavior: "smooth" })
  );
}
...
// --- Seasonal Picks ---
const scrollPick = document.getElementById("box-pick");
if (scrollPick) {
  document.getElementById("nextBtn-pick").addEventListener("click", () =>
    scrollPick.scrollBy({ left: 350, behavior: "smooth" })
  );
  document.getElementById("prevBtn-pick").addEventListener("click", () =>
    scrollPick.scrollBy({ left: -350, behavior: "smooth" })
  );
}
